...
[https://github.com/ZBoxApp/nowjs-client/releases/download/v0.1.2/nowjs-client-v0.1.2.tar.gz](https://github.com/ZBoxApp/nowjs-client/releases/download/v0.1.2/nowjs-client-v0.1.2.tar.gz)

#### Download from S3 or use it as a CDN

Download the js file from Amazon S3 or reference it directly in your project from:

[https://s3-sa-east-1.amazonaws.com/zbox-now/nowjs-client/nowjs-client-v0.1.2.min.js](https://s3-sa-east-1.amazonaws.com/zbox-now/nowjs-client/nowjs-client-v0.1.2.min.js)

Or download the .tar.gz

[https://s3-sa-east-1.amazonaws.com/zbox-now/nowjs-client/nowjs-client-v0.1.2.tar.gz](https://s3-sa-east-1.amazonaws.com/zbox-now/nowjs-client/nowjs-client-v0.1.2.tar.gz)
...
```HTML
    <script src="<path-to-the-js-file/nowjs-client-v0.1.2.min.js"></script>
```
